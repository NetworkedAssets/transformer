...
public interface Throwing {
    ...
    static <T, R, E extends Throwable, RE extends RuntimeException>
    java.util.function.Function<T, R> functionRethrowAsSpecificRuntimeException(
            java.util.function.Function<Throwable, RE> exceptionMapper,
            Specific.Function<T, R, E> throwingFunction
    ) {
        return t -> {
            try {
                return throwingFunction.apply(t);
    ...
    static <T, E extends Throwable, RE extends RuntimeException>
    java.util.function.Consumer<T> consumerRethrowAsSpecificRuntimeException(
            java.util.function.Function<Throwable, RE> exceptionMapper,
            Specific.Consumer<T, E> cons
    ) {
        return t -> {
            try {
                cons.accept(t);
    ...
    static <T, E extends Throwable> java.util.function.Consumer<T> consumerRethrowAsTransformerException(
            Specific.Consumer<T, E> cons
    ) {
        return consumerRethrowAsSpecificRuntimeException(TransformerException::new, cons);
    }

    static <T, R, E extends Throwable> java.util.function.Function<T, R> functionRethrowAsTransformerException(
            Specific.Function<T, R, E> cons
    ) {
        return functionRethrowAsSpecificRuntimeException(TransformerException::new, cons);
    }
